...
public class CommExecutThread extends Thread {
    private Context mContext;
//    private Handler handler;
    private WeakReference weakReference;
    private String sid;

    public CommExecutThread(Context contextg/*, Handler arg2*/, String arg3, WeakReference arg4) {
        mContext = contextg;
//        handler = arg2;
        sid = arg3;
        weakReference = arg4;
    ...
    public void run()
    {
        ...
        {
            FooRoot v7 = (FooRoot) weakReference.get();
            if (v7!= null)
            {
