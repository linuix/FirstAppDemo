...
public class RootThread2 extends Thread {
    ...
    public RootThread2(RootProcess2 arg1, String name, InputStream arg2, OutputStream arg3) {
        super(name);//添加线程的名称
        in = arg2;
        out = arg3;
        lock = RootProcess2.getObject(arg1);
    }
